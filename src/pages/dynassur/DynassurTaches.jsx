              ...
              <Card titre={periodLabel}
                ...
                <div style={{ padding: 12 }}>
                  {viewMode === 'mois' ? <>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: viewMode === '30j' ? 'repeat(auto-fill,minmax(90px,1fr))' : `repeat(${days.length},1fr)`, gap: 6 }}>
                      {days.map(d => <DayCell key={key(d)} d={d} inMonth parJour={parJour} todayKey={todayKey} selDay={selDay} onPick={setSelDay} onTask={openTask} detailed={viewMode !== '30j'} />)}
                    </div>
                  )}
                </div>
              </Card>
