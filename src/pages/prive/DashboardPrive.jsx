    ...
    <Layout currentPage="Tableau de bord">
      <div style={{ fontFamily:"'Source Sans Pro', sans-serif", maxWidth:1200 }}>
        ...
        <div style={{ marginBottom:24 }}>
          <h1 style={{ fontSize:22, fontWeight:800, color:'#134e4a', margin:'0 0 4px' }}>Bonjour {firstName} 👋</h1>
          <p style={{ fontSize:14, color:'#64748b', margin:0 }}>{'Privé'} — aperçu de l'activité</p>
        </div>
        ...
        <div style={{ marginBottom:24 }}>
          <BlocComptes societeCode="PRIVE" color="#0d9488" />
        </div>
