  ...
  return (
    <Layout currentPage="Tableau de bord">
      <div style={{ fontFamily:"'Source Sans Pro', sans-serif", maxWidth:'1200px' }}>
        <h1 style={{ fontSize:'22px', fontWeight:'700', color:'#134e4a', margin:'0 0 4px' }}>Bonjour {firstName} 👋</h1>
        <p style={{ fontSize:'14px', color:'#64748b', margin:'0 0 28px' }}>Privé — tableau de bord</p>
