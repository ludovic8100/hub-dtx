...
const ACCES = [
  ...
  { acc: 'acc_lode', label: 'LODE', pfx: 'lode', couleur: '#F97316',
    pages: [['dashboard', 'Tableau de bord'], ['clients', 'Clients'], ['banque', 'Banque'], ['comptabilite', 'Comptabilité'], ['devis', 'Devis & Factures']] },
  { acc: 'acc_hexagroup', label: 'Hexagroup', pfx: 'hex', couleur: '#ec4899',
    pages: [['dashboard', 'Tableau de bord'], ['banque', 'Banque'], ['comptabilite', 'Comptabilité']] },
  { acc: 'acc_prive', label: 'Privé', pfx: 'prive', couleur: '#22c55e',
    pages: [['dashboard', 'Tableau de bord'], ['banque', 'Banque'], ['comptabilite', 'Comptabilité']] },
  { acc: 'acc_holding', label: 'Groupe (consolidé)', pfx: null, couleur: '#7c3aed', pages: [] },
]
