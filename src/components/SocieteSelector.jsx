...
function SocieteLogo({ societeKey, size = 30 }) {
  const logos = {
  ...
  return (
    <div style={{ padding: '12px 10px 8px', borderBottom: '1px solid rgba(255,255,255,0.08)' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '3px' }}>
        {societesDispo.map(s => {
          ...
          return (
            ...
            >
              {s.key === 'groupe' ? <GroupeLogo size={30} /> : <SocieteLogo societeKey={s.key} size={30} />}
              <div style={{ flex: 1 }}>
                <div style={{
                  fontSize: '13px',
      ...
      <div style={{
        ...
        borderRadius: '2px', marginTop: '10px', opacity: 0.6, transition: 'background 0.3s'
      }} />
    </div>
  )
}
